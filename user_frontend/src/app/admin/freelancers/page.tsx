  ...
  return (
    <div className="flex-1 p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500">Browse and manage freelancers on your platform.</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          {displayedFreelancers.map((freelancer) => (
            <div key={freelancer.id} className="bg-white shadow-md rounded-xl p-6 w-full flex flex-col md:flex-row items-start md:items-center gap-6">
