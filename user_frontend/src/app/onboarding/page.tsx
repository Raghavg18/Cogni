...
const StripeOnboardingPage = () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (response.data.transfersEnabled) {
          setSuccess("Your Stripe account is connected and ready to receive payments!");
        }
      }
      setLoading(false);
    } catch (error) {
  ...
  const connectStripe = async () => {
    try {
      ...
      const response = await axios.post("http://localhost:8000/connect-stripe", {
        username: username
      });
      ...
      setError(error.response?.data?.message || "Failed to connect to Stripe");
    }
  };
      ...
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
        <div className="p-8">
          ...
          <p className="text-gray-600 mb-8 text-center">
            To receive payments for your completed milestones, you need to connect your Stripe account.
          </p>
          ...
          <div className="mt-8 border-t border-gray-200 pt-6">
            <h3 className="text-gray-900 font-medium mb-2">Why connect Stripe?</h3>
            <ul className="list-disc pl-5 text-gray-600 space-y-2">
              <li>Securely receive payments directly to your bank account</li>
              <li>Get paid instantly when clients release milestone payments</li>
